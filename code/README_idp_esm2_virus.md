# IDP-ESM2 — OOD Viruses Experiment

This script evaluates the pretrained **IDP-ESM2-8M** and **IDP-ESM2-150M** models on the BENDER dataset with **Viruses as the OOD kingdom**. A lightweight GeoHead MLP is trained on top of frozen ESM2 embeddings to predict IDP geometric properties, then evaluated on a BENDER test set and OOD Virus sequences.
...
| `all_results.csv` | R² scores for all splits (BENDER test + OOD Viruses) |
